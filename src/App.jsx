    ...
    <>
      ...
      <section className="section" style={{
        ...
        <div className="container">
            <h2 style={{fontSize: '2rem', marginBottom: '15px', fontWeight: '800', color: '#ffffff'}}>
            ...
            <a href="https://www.youtube.com/@InsetLarDedetizadora" target="_blank" className="btn btn-outline" style={{borderColor: '#fff', color: '#fff'}} rel="noopener noreferrer">
      ...
      <a href="https://api.whatsapp.com/send/?phone=5564992886851&text=Ol%C3%A1%21+Vim+pelo+site+e+quero+um+or%C3%A7amento+premium." className="float-whatsapp" target="_blank" rel="noopener noreferrer">
