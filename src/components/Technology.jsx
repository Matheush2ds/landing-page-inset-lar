      ...
      <div className="container tech-content">
        <div className="tech-text">
          ...
          <div className="highlight-box">
             <p style={{margin:0, color: '#fff', fontSize: '1.1rem'}}>Eficácia comprovada e segurança total para o seu ambiente.</p>
          </div>
        </div>
        
        <div className="tech-grid">
          <div className="tech-card">
            <Lightning size={32} color="#00A859" style={{marginBottom: '10px'}} />
            <h4>Ação Inseticida</h4>
            <p>Elimina os insetos adultos imediatamente após o contato.</p>
          </div>
          <div className="tech-card">
            <ShieldCheck size={32} color="#00A859" style={{marginBottom: '10px'}} />
            <h4>Ação Residual</h4>
            <p>O produto permanece ativo nas superfícies, protegendo por semanas.</p>
          </div>
          <div className="tech-card">
            <Wind size={32} color="#00A859" style={{marginBottom: '10px'}} />
            <h4>Ação Desalojante</h4>
            <p>Força os insetos a saírem de frestas profundas para serem eliminados.</p>
          </div>
          <div className="tech-card">
            <Skull size={32} color="#00A859" style={{marginBottom: '10px'}} />
